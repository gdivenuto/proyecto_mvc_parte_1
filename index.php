  	...
  	<body>
						...
						<nav class="navbar navbar-default menu_fondo" role="navigation">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse padding_top_20">
							    ...
							    <ul class="nav navbar-nav">
									...
									<li class="dropdown">
							      		<li class="disabled"><a class="menu_item" title="NO IMPLEMENTADO" href="javascript:refrescar('abms/index.php?controlador=productos&accion=listar', '#contenidoAjaxPrincipal');">PRODUCTOS</a></li>
							      	</li>
								</ul>
							</div>
						</nav>
	    ...
	    <script>
	        $(document).ready(function(){
	            ...
	            refrescar('abms/index.php?controlador=categorias&accion=listar', '#contenidoAjaxPrincipal');
	        });
	    </script>
  	</body>
</html>
