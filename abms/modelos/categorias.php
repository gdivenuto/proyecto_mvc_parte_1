...
class categoriasModelo extends ModeloBaseMySQLi
{
	...
	public function obtenerRegistro($id)
	{
		...
		$query = "SELECT * FROM ".$this->tabla_categorias." WHERE c_id = ".$id;
	...
	public function existe($c_nombre)
	{	
		$conexion = $this->conectar();
		
		$query = "SELECT c_nombre FROM ".$this->tabla_categorias." WHERE c_nombre = '".$c_nombre."'";
	...
	public function insertar($datos)
	{
		...
		$datos['c_id'] = $this->obtenerUltimoId() + 1;
